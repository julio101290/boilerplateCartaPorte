...
<div class="row comprobantesRD" hidden>
    ...
    <div class="col-6 pull-right" style="text-align: right;">
        <div class="form-group ">
            ...
            <input type="text" id="folioComprobanteRD" name="folioComprobanteRD" disabled value="">
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-2" >
        <div class="form-group">
            <label for="TranspInternac">Traspaso Internacional </label>
            <select id='TranspInternac' name='TranspInternac' class="TranspInternac" style='width: 100%;'>

                <?php
                if (isset($TranspInternac)) {

                    echo "   <option value='$TranspInternac'>$TranspInternac</option>";
                } else {
    ...
    <div class="col-2" >
        <div class="form-group">
            <label for="custumerSell">Total Distancia Recorrida </label>
            <input class="form-control" type="text" id='TotalDistRec' name='TotalDistRec' value="<?= $TotalDistRec ?>">
            </select>
        </div>
    </div>
...
<div class="row">
    ...
    <div class="col-6">
        <div class="form-group">
            ...
            <button type="button" class="btn btn-default btnAgregarMercancia" data-toggle="modal" data-target="#modalAddbtnAddMercancia">Agregar Mercancia</button>
